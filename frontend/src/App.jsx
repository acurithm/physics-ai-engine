  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#000' }}>
      ...
      <div style={{ width: sidebarOpen ? '260px' : '0px', transition: '0.3s', background: '#111', borderRight: '1px solid #333', overflow: 'hidden', padding: sidebarOpen ? '20px' : '0' }}>
        ...
        <div style={{ color: '#888', fontSize: '14px' }}>Thermodynamics Basics...</div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
        ...
        <div style={{ padding: '20px', display: 'flex', gap: '10px' }}>
          <input value={query} onChange={(e) => setQuery(e.target.value)} style={{ flex: 1, background: '#1a1a1a', border: '1px solid #333', color: '#fff', padding: '15px', borderRadius: '25px', outline: 'none' }} placeholder="Ask Acurithm..." />
